 ...
 * @param  {Number} interval       forwards interval. defalut forwards 10ms latter
 * @constructor
 */
function Forwards(from, to, reconnectTime, interval) {
  ...
  this.interval = isNaN(this.interval) ? 10 : this.interval;
  this.working = false;
  var self =  this;
  this.eventHandles = {
    data: function(data) {
